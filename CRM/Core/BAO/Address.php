...
/*
 ...
 +--------------------------------------------------------------------+
 | CiviCooP mod as part of org.civicoop.streetformatnl                |
 | added nl_NL as possible locale in function parseStreetAddress      |
...
ORDER BY civicrm_address.is_primary DESC, civicrm_address.location_type_id DESC, address_id ASC ";
  ...
  static function parseStreetAddress($streetAddress, $locale = NULL) {
     ...
     *  default is en_US
     */
    // CiviCooP, Erik Hommel: change for org.civicoop.streetformatnl
